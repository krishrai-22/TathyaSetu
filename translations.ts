...
const enTranslation: TranslationSchema = {
  ...
  heroSubtitle: "Instantly verify facts and detect misinformation across multiple languages and formats.",
...
export const translations: Record<Language, TranslationSchema> = {
  ...
  mr: {
    ...
    inputPlaceholder: "येथे मजकूर पेस्ट करा किंवा मीडिया अपलोड करें...",
