...
const enTranslation: TranslationSchema = {
  ...
  modal: {
    ...
    steps: [
      "Step 1: The AI extracts core claims from your input.",
    ...
    bias: "Bias Check",
    biasDesc: "The AI analyzes loaded language and emotional tactics.",
    gotIt: "Got it",
    // Unique Section
    ...
    uniqueFeatures: [
      ...
      { title: "Audio Summary", desc: "Listen to the analysis in your language with our AI Text-to-Speech integration." },
...
export const translations: Record<Language, TranslationSchema> = {
  ...
  hi: {
    ...
    heroTitle: "AI-संचालित फैक्ट और गलत सूचना चेकर",
    heroSubtitle: "टेक्स्ट और लिंक में तथ्यों को सत्यापित करें।",
    inputPlaceholder: "सत्यापन के लिए यहाँ टेक्स्ट पेस्ट करें...",
  ...
  hinglish: {
    ...
    heroTitle: "AI-Powered Fact and Misinformation Checker",
    heroSubtitle: "Facts verify karein text aur links mein.",
    inputPlaceholder: "Yahan text paste karein verify karne ke liye...",
  ...
  bn: {
    ...
    inputPlaceholder: "যাচাই করার জন্য টেক্সট পেস্ট করুন...",
  ...
  te: {
    ...
    inputPlaceholder: "టెక్స్ట్‌ని ఇక్కడ పేస్ట్ చేయండి...",
  ...
  ta: {
    ...
    inputPlaceholder: "உரையை இங்கே ஒட்டவும்...",
  ...
  mr: {
    ...
    inputPlaceholder: "येथे मजकूर पेस्ट करा...",
    ...
    verdictLabels: {
      ...
      [VerdictType.FALSE]: { label: "चुकीची माहिती", desc: "यात चुकीचे दावे हैं." },
  ...
  gu: {
    ...
    inputPlaceholder: "ટેક્સ્ટ અહીં પેસ્ટ કરો...",
  ...
  kn: {
    ...
    inputPlaceholder: "ಪಠ್ಯವನ್ನು ಇಲ್ಲಿ ಅಂಟಿಸಿ...",
